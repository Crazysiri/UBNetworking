#
#  Be sure to run `pod spec lint UBNetworking.podspec' to ensure this is a
...
1.3.3:增加参数   needs:(id<XDJRequestCommonNeedsDelegate,XDJReponseCommonNeedsDelegate>)needs //use default needs if nil
  ...
  s.author             = { "Uber" => "511121933@qq.com" }
  # Or just: s.author    = "Uber"
  # s.authors            = { "Uber" => "511121933@qq.com" }
  # s.social_media_url   = "http://twitter.com/Uber"
  ...
  s.source_files  = "UBNetworking/**/*.{h,m}"
